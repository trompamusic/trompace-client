...
class TestDocument(CeTestCase):
    ...
    def test_create(self):
        expected = self.read_file(os.path.join(self.data_dir, "EXPECTED_DOCUMENT.txt"))
    ...
    def test_update(self):
        expected = self.read_file(os.path.join(self.data_dir, "EXPECTED_DOCUMENT_UPDATE.txt"))
    ...
    def test_delete(self):
        expected = self.read_file(os.path.join(self.data_dir, "EXPECTED_DOCUMENT_DELETE.txt"))
    ...
    def test_add_broad_match(self):
        expected = self.read_file(os.path.join(self.data_dir, "EXPECTED_DOCUMENT_BROAD_MATCH.txt"))
    ...
    def test_remove_broad_match(self):
        expected = self.read_file(os.path.join(self.data_dir, "EXPECTED_DOCUMENT_REMOVE_BROAD_MATCH.txt"))
    ...
    def test_add_exampleOf(self):
        expected = self.read_file(os.path.join(self.data_dir, "expected_Document_add_exampleOf_Composition.txt"))
    ...
    def test_merge_exampleOf(self):
        expected = self.read_file(os.path.join(self.data_dir, "expected_Document_merge_exampleOf_Composition.txt"))
    ...
    def test_remove_exampleOf(self):
        expected = self.read_file(os.path.join(self.data_dir, "expected_Document_remove_exampleOf_Composition.txt"))

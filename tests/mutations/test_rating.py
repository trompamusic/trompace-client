...
class TestRating(CeTestCase):
    ...
    def test_create_rating_basic(self):
        ...
        assert self.compare_queries(create_rating, expected)
    ...
    def test_update_rating_single(self):
        ...
        assert self.compare_queries(update_rating, expected)
    ...
    def test_delete_rating(self):
        ...
        assert self.compare_queries(delete_rating, expected)

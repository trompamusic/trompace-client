...
import os
import unittest
from trompace.queries import mediaobject as mediaobject_query
...
class TestDocument(unittest.TestCase):
    ...
    def test_query(self):
        ...
        created_mediaobject = mediaobject_query.query_mediaobject(identifier="ff59650b-1d47-4ea5-b356-31fddeb48315")
        self.assertEqual(created_mediaobject, expected)

    def test_query_all(self):
        expected = util.read_file(self.data_dir, "query_mediaobject.txt")

        created_mediaobject = mediaobject_query.query_mediaobject()
        self.assertEqual(created_mediaobject, expected)
